const HomeIcon = ({size}) => {
    return (
        <svg role="img" width={size} height={size} class="Svg-ytk21e-0 jAKAlG home-active-icon" aria-hidden="true" viewBox="0 0 24 24">
            <path 
...
const PlusIcon = ({size}) => {
    return (
        <svg role="img" width={size} height={size} aria-hidden="true" viewBox="0 0 16 16" class="Svg-ytk21e-0 jAKAlG">
...
const DownloadIcon = ({size}) => {
    return (
        <svg role="img" width={size} height={size} aria-hidden="true" viewBox="0 0 24 24" class="Svg-ytk21e-0 jAKAlG">
